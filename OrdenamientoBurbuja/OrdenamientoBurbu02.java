...
/**
    ...
    Solicite al usuario ingresar un arreglo de 12 números enteros desordenados o en su caso aplique la 
    función de números aleatorios, una vez que tenga el arreglo con los números, implemente el algoritmo de 
    ordenamiento de burbuja para ordenar el arreglo en orden descendente . recuerda imprimir ambos arreglos, 
    el desordenado y el ordenado
 */
public class OrdenamientoBurbu02 {
